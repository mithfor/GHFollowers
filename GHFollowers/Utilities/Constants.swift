...
enum DeviceTypes {
    ...
    static let isiPhonePlusStandart = idiom == .phone && ScreenSize.maxLength == 736.0
    static let isiPhonePlusZoomed   = idiom == .phone && ScreenSize.maxLength == 736.0 && nativeScale < scale
